...
def test_generate_presigned_post_perf_sync_cm(rustfs_server, perf_test_dir):
    ...
    test_dir = perf_test_dir / Path("test_generate_presigned_post_perf_sync_cm")
...
def test_generate_presigned_url_perf_sync_cm(rustfs_server, perf_test_dir):
    ...
    """
    py_vers = sys.version_info
    test_dir = perf_test_dir / Path("test_generate_presigned_url_perf_sync_cm")
    os.makedirs(test_dir, exist_ok=True)
    result_file: Path = test_dir / Path(f"run_{py_vers.major}.{py_vers.minor}.json")
    rng = random.Random(42)  # noqa: S311
    bucket = "perf-bucket"
...
def test_head_bucket_perf_sync_cm(rustfs_server, perf_test_dir):
    ...
    """
    py_vers = sys.version_info
    test_dir = perf_test_dir / Path("test_head_bucket_perf_sync_cm")
    os.makedirs(test_dir, exist_ok=True)
    result_file: Path = test_dir / Path(f"run_{py_vers.major}.{py_vers.minor}.json")
    bucket = "perf-bucket"
...
def test_head_object_perf_sync_cm(rustfs_server, perf_test_dir):
    ...
    """
    py_vers = sys.version_info
    test_dir = perf_test_dir / Path("test_head_object_perf_sync_cm")
    os.makedirs(test_dir, exist_ok=True)
    result_file: Path = test_dir / Path(f"run_{py_vers.major}.{py_vers.minor}.json")
    bucket = "perf-object"
    key = "perf-object.txt"
...
def test_create_bucket_perf_sync_cm(rustfs_server, perf_test_dir):
    ...
    """
    py_vers = sys.version_info
    test_dir = perf_test_dir / Path("test_create_bucket_perf_sync_cm")
    os.makedirs(test_dir, exist_ok=True)
    result_file: Path = test_dir / Path(f"run_{py_vers.major}.{py_vers.minor}.json")
