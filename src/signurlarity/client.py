...
class Client:
    ...
    def __init__(
        ...
        self._http_client = httpx.Client(limits=limits)
    ...
    def _execute_request(
        ...
        Uses the instance's httpx.Client for connection pooling, reusing
    ...
    def delete_objects(self, Bucket: str, Delete: dict[str, Any], **kwargs):
