...
class S3PresignedURLGenerator:
    ...
    def generate_presigned_url(self, bucket: str, key: str, method: str = 'GET',
                               expires: int = 3600, timestamp=None) -> str:
...
if __name__ == '__main__':
    ...
    url = gen.generate_presigned_url("examplebucket", "test.txt",
                                     expires=86400, timestamp=test_time)
